...
describe('CardService', () => {
  ...
  it('should create a card', async () => {
    ...
    (prisma.card.aggregate as jest.Mock).mockResolvedValue({
      _max: { order: 1 },
    });
  ...
  it('should throw if board not found when creating card', async () => {
    ...
    await expect(
      service.createCard('board123456', {
        title: 'x',
        description: 'y',
        column: 'todo',
      } as any),
  ...
  it('should update a card', async () => {
    ...
    const result = await service.updateCard('card123456', {
      title: 'Updated Card',
    } as any);
  ...
  describe('moveCard', () => {
    ...
    it('should move card within the same column (up)', async () => {
      ...
      const result = await service.moveCard('card123456', {
        column: 'todo',
        order: 1,
      } as any);
